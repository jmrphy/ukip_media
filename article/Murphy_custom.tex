...
$for(author)$\textbf{\authorfont $author.name$} \\ \emph{\small $author.affiliation$} \\ \medskip $sep$ \par $endfor$
  \vskip 1.5em%
}
...
\noindent \footnotesize \textbf{Abstract:} $abstract$

$if(keywords)$

\vskip 8.5pt \noindent \footnotesize \emph{Keywords}: $keywords$ \par
